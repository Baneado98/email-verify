...
app.get("/.well-known/x402-listing", (_req, res) =>
  res.json({
    ...
    mcp: { npx: "mailbox-verify-mcp", http: "https://email-verify.vercel.app/mcp" },
    endpoints: [
      {
        method: "GET",
        path: "/pro/verify",
