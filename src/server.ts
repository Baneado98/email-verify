...
app.get("/.well-known/x402-listing", (_req, res) =>
  res.json({
    ...
    mcp: { npx: "email-verify-mcp", http: "https://email-verify.vercel.app/mcp" },
    endpoints: [
      {
        method: "GET",
        path: "/pro/verify",
        resource: "https://email-verify.vercel.app/pro/verify?email=jane@example.com",
      ...
      },
      {
        ...
        resource: "https://email-verify.vercel.app/pro/verify_many?emails=jane@example.com,foo@mailinator.com",
        price: { amount: "0.05", currency: "USD", asset: "USDC", network: "base" },
        payTo: PAYTO,
        scheme: "exact",
    ...
    free: { verify: "https://email-verify.vercel.app/verify?email=jane@example.com" },
  }));
